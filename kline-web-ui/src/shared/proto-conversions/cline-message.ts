...
import { ClineAsk, ClineMessage, ClineMessageType, ClineSay, ClineMessage as ProtoClineMessage } from "../proto/cline/ui"
...
function convertClineSayToProtoEnum(say: AppClineSay | undefined): ClineSay | undefined {
	...
	const mapping: Record<AppClineSay, ClineSay> = {
		...
		completion_result: ClineSay.COMPLETION_RESULT,
		...
		command: ClineSay.COMMAND,
		command_output: ClineSay.COMMAND_OUTPUT,
		tool: ClineSay.TOOL,
		...
		browser_action_launch: ClineSay.BROWSER_ACTION_LAUNCH,
		...
		use_mcp_server: ClineSay.USE_MCP_SERVER,
		...
		load_tool_set: ClineSay.LOAD_TOOL_SET,
		info: ClineSay.INFO,
...
function convertProtoEnumToClineSay(say: ClineSay): AppClineSay | undefined {
	...
	const mapping: Record<Exclude<ClineSay, ClineSay.UNRECOGNIZED>, AppClineSay> = {
		...
		[ClineSay.COMPLETION_RESULT]: "completion_result",
		...
		[ClineSay.COMMAND]: "command",
		[ClineSay.COMMAND_OUTPUT]: "command_output",
		[ClineSay.TOOL]: "tool",
		[ClineSay.SHELL_INTEGRATION_WARNING]: "shell_integration_warning",
		[ClineSay.BROWSER_ACTION_LAUNCH]: "browser_action_launch",
		...
		[ClineSay.USE_MCP_SERVER]: "use_mcp_server",
		...
		[ClineSay.LOAD_TOOL_SET]: "load_tool_set",
		[ClineSay.INFO]: "info",
 ...
 */
export function convertProtoToClineMessage(protoMessage: ClineMessage): AppClineMessage {
