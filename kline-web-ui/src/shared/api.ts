...
export interface ApiHandlerSecrets {
	/** key = ApiProvider 字符串，如 "mistral"、"deepseek" */
...
export function getApiKey(ac: ApiConfiguration | undefined, provider: ApiProvider): string | undefined {
	return ac?.apiKeys?.[provider]
}
