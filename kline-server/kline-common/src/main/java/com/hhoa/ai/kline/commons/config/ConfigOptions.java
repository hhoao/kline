...
import static com.hhoa.ai.kline.commons.config.KlineVersion.all;
...
public class ConfigOptions {
    ...
    public static final class OptionBuilder {
        ...
        public <T> ConfigOption<T> defaultValue(T value) {
            ...
            return new ConfigOption<>(
                    key, value.getClass(), ConfigOption.EMPTY_DESCRIPTION, value, false, all());
        }
        ...
        public ConfigOption<String> noDefaultValue() {
            return new ConfigOption<>(
                    key, String.class, ConfigOption.EMPTY_DESCRIPTION, null, false, all());
        }
    }
    ...
    public static class TypedConfigOptionBuilder<T> {
        ...
        public ConfigOption<T> defaultValue(T value) {
            return new ConfigOption<>(
                    key, clazz, ConfigOption.EMPTY_DESCRIPTION, value, false, all());
        }
        ...
        public ConfigOption<T> noDefaultValue() {
            return new ConfigOption<>(
                    key, clazz, Description.builder().text("").build(), null, false, all());
        }
    }
    ...
    public static class ListConfigOptionBuilder<E> {
        ...
        public final ConfigOption<List<E>> defaultValues(E... values) {
            return new ConfigOption<>(
                    key, clazz, ConfigOption.EMPTY_DESCRIPTION, Arrays.asList(values), true, all());
        }
        ...
        public ConfigOption<List<E>> noDefaultValue() {
            return new ConfigOption<>(
                    key, clazz, ConfigOption.EMPTY_DESCRIPTION, null, true, all());
        }
    }
