...
public class PgTimestampType extends PgCustomType {

    private static final Set<String> INPUT_CONVERSION = conversionSet(Timestamp.class.getName());
    ...
    public PgTimestampType(boolean isNullable, LogicalTypeRoot typeRoot, boolean isArray) {
    ...
    public LogicalType copy(boolean isNullable) {
        return new PgTimestampType(isNullable, getTypeRoot(), isArray());
    }
}
