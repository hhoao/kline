 ...
 *
 * <p>Note: In most of the cases, {DataTypeExtractor} is more useful as it also considers structured
 * types and type variables possibly annotated with {DataTypeHint}.
 */
