...
public class SqlDateColumn extends AbstractBaseColumn {
    ...
    public Boolean asBooleanInternal() {
        ...
        throw new CastException(Date.class.getTypeName(), "Boolean", this.asStringInternal());
    }
    ...
    public byte[] asBytesInternal() {
        ...
        throw new CastException(Date.class.getTypeName(), "Bytes", this.asStringInternal());
    }
    ...
    public Time asTimeInternal() {
        ...
        throw new CastException(Date.class.getTypeName(), "java.sql.Time", this.asStringInternal());
    }
