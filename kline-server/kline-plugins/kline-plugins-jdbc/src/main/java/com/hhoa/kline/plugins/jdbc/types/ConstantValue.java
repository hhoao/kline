...
public class ConstantValue {
    ...
    public static final String DATA_TYPE_ZERO_FILL_LOWER = "zerofill";
    ...
    public static final String DDL_CONVERT_DIR_NAME = "ddl-plugins";

    public static final String CATALOG_DIR_NAME = "catalog";

    public static final String USER_CLASSPATH_DIR_NAME = "user-classpath";
    public static final String USER_CLASSPATH_SYNC_DIR_NAME = "sync";
