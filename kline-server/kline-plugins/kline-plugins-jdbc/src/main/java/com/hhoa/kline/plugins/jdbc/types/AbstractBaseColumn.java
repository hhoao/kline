...
import com.hhoa.kline.plugins.jdbc.types.column.ZonedTimestampColumn;
...
public abstract class AbstractBaseColumn implements Serializable {
    ...
    public Byte asByte() {
        ...
        BigDecimal asBigDecimal = this.asBigDecimal();
    ...
    public ZonedTimestampColumn asZonedTimestamp() {
        ...
        return new ZonedTimestampColumn(timestamp);
    }
