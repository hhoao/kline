...
/**
 * Hermes-specific component override templates. Provides optimized prompt text for Hermes-4 model
 * family. Nous recommends the thinking component be added explicitly for hermes-4.
 *
 * @author hhoa
 */
public final class HermesComponentOverrides {

    private HermesComponentOverrides() {}
    ...
    private static final String HERMES_OBJECTIVE_TEMPLATE =
            """
            OBJECTIVE
    ...
    private static final String HERMES_TASK_PROGRESS_TEMPLATE =
            """
    ...
    private static final String HERMES_MCP_TEMPLATE =
            """
            MCP SERVERS
    ...
    private static String hermesRulesTemplate(SystemPromptContext context) {
    ...
    public static Map<SystemPromptSection, ConfigOverride> getOverrides() {
        return Map.of(
                ...
                ConfigOverride.create().template(HERMES_AGENT_ROLE_TEMPLATE),
                SystemPromptSection.TOOL_USE,
                ConfigOverride.create().template(HERMES_TOOL_USE_TEMPLATE),
                ...
                ConfigOverride.create().template(HERMES_MCP_TEMPLATE));
    }
}
