...
public class ActVsPlanModeComponent implements SystemPromptComponent {
    ...
    public String apply(PromptVariant variant, SystemPromptContext context) {
        ...
        if (variant.getComponentOverrides() != null
                && variant.getComponentOverrides().containsKey(SystemPromptSection.ACT_VS_PLAN)) {
            var override = variant.getComponentOverrides().get(SystemPromptSection.ACT_VS_PLAN);
    ...
    public SystemPromptSection getSystemPromptSection() {
        return SystemPromptSection.ACT_VS_PLAN;
    }
    ...
    private String getTemplateText(SystemPromptContext context) {
        ...
        return String.format(
            ...
            - When starting in PLAN MODE, depending on the user's request, you may need to do some information gathering e.g. using read_file or search_files to get more context about the task.%s
