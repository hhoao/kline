...
/**
 * Gemini 3 variant configuration - Prompt optimized for Gemini 3.0 model with native tool calling
 *
 * @author hhoa
 */
@Slf4j
public class Gemini3VariantConfig {
    ...
    public static PromptVariant createVariant() {
        ...
        placeholders.put("MODEL_FAMILY", ModelFamily.GEMINI_3.name());
        ...
        return PromptVariant.buildAndValidate(
                PromptVariant.builder()
                        ...
                        .componentOverrides(Gemini3ComponentOverrides.getOverrides())
    ...
    static {
        ...
        ConfigTemplate.validateVariantConfig(built, "gemini-3");
        CONFIG = built;
    }
