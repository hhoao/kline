...
public class EditingFilesComponent implements SystemPromptComponent {
    ...
    public String apply(PromptVariant variant, SystemPromptContext context) {
        ...
        if (variant.getComponentOverrides() != null
                && variant.getComponentOverrides().containsKey(SystemPromptSection.EDITING_FILES)) {
            var override = variant.getComponentOverrides().get(SystemPromptSection.EDITING_FILES);
