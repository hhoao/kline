...
/**
 * OpenAI GPT-5.1 variant for deep-planning prompt. Uses 5-step process with separate read and
 * terminal investigation phases. Template is dynamically generated based on focus chain and native
 * tool call settings. 对应 TS deep-planning/variants/gpt51.ts
 *
 * @author hhoa
 */
public final class Gpt51DeepPlanningVariant {
    ...
    public static String generateTemplate(
        ...
        return Gemini3DeepPlanningVariant.generateTemplate(
                focusChainEnabled, enableNativeToolCalls);
    }
}
