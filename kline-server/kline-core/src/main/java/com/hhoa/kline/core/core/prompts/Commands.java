...
import com.hhoa.kline.core.core.prompts.commands.deepplanning.DeepPlanningPromptProvider;
import com.hhoa.kline.core.core.prompts.systemprompt.SystemPromptContext;
import lombok.extern.slf4j.Slf4j;

/**
 * Command prompts for various AI assistant operations
 *
 * @author hhoa
 */
@Slf4j
public class Commands {
    ...
    public static String newTaskToolResponse(boolean willUseNativeTools) {
        ...
        return String.format(
                ...
                Irrespective of whether additional information or instructions are given, you are ONLY allowed to respond to this message by calling the new_task tool.%s
    ...
    public static String newRuleToolResponse() {
        return """
    ...
    public static String reportBugToolResponse() {
        return """
    ...
    public static String explainChangesToolResponse() {
        return """
    ...
    public static String subagentToolResponse() {
        return """
