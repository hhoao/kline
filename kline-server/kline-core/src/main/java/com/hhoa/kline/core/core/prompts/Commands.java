...
public class Commands {
    ...
    public static String newTaskToolResponse() {
        return """
    ...
    public static String condenseToolResponse(Boolean focusChainEnabled) {
        String focusChainText =
                focusChainEnabled != null && focusChainEnabled
    ...
    public static String deepPlanningToolResponse(Boolean focusChainEnabled) {
        String focusChainText =
