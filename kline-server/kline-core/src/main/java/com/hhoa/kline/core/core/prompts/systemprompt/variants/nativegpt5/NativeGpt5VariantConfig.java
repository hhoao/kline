package com.hhoa.kline.core.core.prompts.systemprompt.variants.nativegpt5;
...
/**
 * Native GPT-5 variant configuration - GPT-5 with native tool use support
 *
 * @author hhoa
 */
@Slf4j
public class NativeGpt5VariantConfig {
    ...
    public static PromptVariant createVariant() {
        ...
        placeholders.put("MODEL_FAMILY", ModelFamily.NATIVE_GPT_5.name());
    ...
    static {
        ...
        ConfigTemplate.validateVariantConfig(built, "native-gpt-5");
        CONFIG = built;
    }
