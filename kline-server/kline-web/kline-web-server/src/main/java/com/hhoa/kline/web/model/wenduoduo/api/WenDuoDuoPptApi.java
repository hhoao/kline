package com.hhoa.kline.web.model.wenduoduo.api;
...
public class WenDuoDuoPptApi {
                                    ...
                                    response.bodyToMono(String.class)
                                            .handle(
                                                    (responseBody, sink) -> {
                                                        ...
                                                        log.error(
                                                                "[WenDuoDuoPptApi] 调用失败！请求方式:[{}]，请求地址:[{}]，请求参数:[{}]，响应数据: [{}]",
                                                                request.getMethod(),
                                                                request.getURI(),
                                                                reqParam,
                                                                responseBody);
     ...
     * @return 任务 ID
     * @see <a
     *     href="https://docmee.cn/open-platform/api#%E5%88%9B%E5%BB%BA%E4%BB%BB%E5%8A%A1">创建任务</a>
     */
        ...
        return this.webClient
                ...
                .<Map<String, Object>>handle(
                        (response, sink) -> {
                            if (response.code != 0) {
                                sink.error(
                                        new IllegalStateException("获取生成选项异常，" + response.message));
                                return;
                            }
        ...
        return this.webClient
                ...
                .<PptInfo>handle(
                        (response, sink) -> {
                            if (response.code != 0) {
                                sink.error(
                                        new IllegalStateException("生成 PPT 异常，" + response.message));
                                return;
                            }
                            sink.next(
    ...
    public record CreateTokenRequest(String apiKey, String uid, Integer limit) {
    ...
    /** API 通用响应 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record ApiResponse(Integer code, String message, Map<String, Object> data) {}

    /** 创建任务 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record CreateTaskRequest(Integer type, String content, List<MultipartFile> files) {}

    /** 生成大纲内容请求 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record CreateOutlineRequest(
            String id, String length, String scene, String audience, String lang, String prompt) {}

    /** 修改大纲内容请求 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record UpdateOutlineRequest(String id, String markdown, String question) {}

    /** 生成 PPT 请求参数 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record PptCreateRequest(String id, String templateId, String markdown) {}
    ...
    /** 模板查询请求参数 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record TemplateQueryRequest(int page, int size, Filter filters) {

        /** 模板查询过滤条件 */
        @JsonInclude(value = JsonInclude.Include.NON_NULL)
        public record Filter(int type, String category, String style, String themeColor) {}
    }

    /** PPT模板分页信息 */
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    public record PagePptTemplateInfo(List<PptTemplateInfo> data, String total) {}
