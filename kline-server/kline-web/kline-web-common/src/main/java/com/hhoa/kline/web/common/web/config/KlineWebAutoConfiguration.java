package com.hhoa.kline.web.common.web.config;
...
import com.hhoa.kline.web.common.web.core.filter.CacheRequestBodyFilter;
import com.hhoa.kline.web.common.web.core.filter.DemoFilter;
import com.hhoa.kline.web.common.web.core.handler.GlobalExceptionHandler;
import com.hhoa.kline.web.common.web.core.handler.GlobalResponseBodyHandler;
...
public class KlineWebAutoConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    @ConditionalOnProperty(value = "kline.demo", havingValue = "true")
