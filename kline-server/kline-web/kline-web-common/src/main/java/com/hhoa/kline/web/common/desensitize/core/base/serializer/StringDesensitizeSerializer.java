package com.hhoa.kline.web.common.desensitize.core.base.serializer;
...
import com.hhoa.kline.web.common.desensitize.core.base.annotation.DesensitizeBy;
import com.hhoa.kline.web.common.desensitize.core.base.handler.DesensitizationHandler;
 ...
 * 脱敏序列化器
 *
 * <p>实现 JSON 返回数据时，使用 {@link DesensitizationHandler} 对声明脱敏注解的字段，进行脱敏处理。
 *
 * @author gaibu
 */
...
public class StringDesensitizeSerializer extends StdSerializer<String>
    ...
    @Getter @Setter private DesensitizationHandler desensitizationHandler;
    ...
    public void serialize(String value, JsonGenerator gen, SerializerProvider serializerProvider)
        ...
        // 自定义处理器
        DesensitizeBy[] annotations =
                AnnotationUtil.getCombinationAnnotations(field, DesensitizeBy.class);
