package com.hhoa.kline.web.common.apilog.core.filter;

import static com.hhoa.ai.kline.commons.utils.JsonUtils.toJsonString;
import static com.hhoa.kline.web.common.apilog.core.interceptor.ApiAccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
...
import com.hhoa.ai.kline.commons.exception.enums.GlobalErrorCodeConstants;
import com.hhoa.ai.kline.commons.utils.JsonUtils;
import com.hhoa.kline.web.common.apilog.core.annotation.ApiAccessLog;
import com.hhoa.kline.web.common.apilog.core.enums.OperateTypeEnum;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(
        ...
        HandlerMethod handlerMethod =
                (HandlerMethod) request.getAttribute(ATTRIBUTE_HANDLER_METHOD);
        ...
        String[] sanitizeKeys =
                accessLogAnnotation != null ? accessLogAnnotation.sanitizeKeys() : null;
    ...
    private static String sanitizeJson(CommonResult<?> commonResult, String[] sanitizeKeys) {
        ...
        try {
            JsonNode rootNode = JsonUtils.parseTree(jsonString);
            sanitizeJson(
                    rootNode.get("data"), sanitizeKeys); // 只处理 data 字段，不处理 code、msg 字段，避免错误被脱敏掉
            return toJsonString(rootNode);
        } catch (Exception e) {
            // 脱敏失败的情况下，直接忽略异常，避免影响用户请求
            log.error("[sanitizeJson][脱敏({}) 发生异常]", jsonString, e);
